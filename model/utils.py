...
def get_args(is_train=True):
    ...
    parser.add_argument('--num_iter', type=int, default=320, help='number of iterations to train for')
    parser.add_argument('--valInterval', type=int, default=80, help='Interval between each validation')
    ...
    parser.add_argument('--select_data', type=str, default='/', 
                     help='select training data (default is our synthetic dataset)') 
    ...
    """ W&B logging"""
    parser.add_argument('--wnb_entity', type=str, default='ai_tech_level2-cv-18', help='the entity of W&B')
    parser.add_argument('--wnb_project', type=str, default='test', help='the project of W&B')
    parser.add_argument('--wnb_name', type=str, help='the name of W&B')
